...
public class LevelEditor : EditorWindow
{
    ...
    {
        GameObject parent = GameObject.Find("LevelHolder");
        if (parent != null)
        {
            DestroyImmediate(parent);
        }
        parent = new GameObject("LevelHolder");
        parent.transform.position = new Vector2(target.levelwidth / 2, -target.levelheight / 2);
    ...
    void Clear()
    {
        ...
        DestroyImmediate(GameObject.Find("LevelHolder"));
    }
}